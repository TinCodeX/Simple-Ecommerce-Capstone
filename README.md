...
A robust and scalable RESTful API for managing an e-commerce platform, built using Django and Django REST Framework (DRF). This API provides complete backend functionality for product management, user authentication, wishlists, and secure access using JWT.
